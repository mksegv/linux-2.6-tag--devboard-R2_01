 ...
 * differently. On the CRIS architecture, we normally just read/write 
 * the memory location directly. When PCI/Cardbus is enabled we may
 * have to go trough the bridge.
 */
#ifdef CONFIG_PCI
